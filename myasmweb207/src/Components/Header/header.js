    ...
    return(
        ...
        <div className="flex w-2/4   items-center">
            <ul className="flex text-white mx-auto">
                <li className="mx-2 lg:mx-5 "><Link to="/">SẢN PHẨM</Link></li>
        ...
        <div className="flex w-1/4 text-white items-center lg:pl-20">
            ...
            <Link to="/cart" className="relative">
                ...
                <p className="absolute top-1 right-0  h-4 w-4 flex items-center justify-center rounded-full bg-red-500 p-1">{cartTotal}</p>
            </Link>
         </div>
    </div>
    );
